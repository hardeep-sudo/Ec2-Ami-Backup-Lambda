...
def lambda_handler(event, context):
  ...
  for instance in instances:
    try:
      ...
      nametag = amiName + "-" + instance['InstanceId'] + "-" + create_fmt

      AMIid = ec.create_image(InstanceId=instance['InstanceId'], Name= nametag, Description="Automated created AMI of instance " + instance['InstanceId'] + " on " + create_fmt, NoReboot=True, DryRun=False)
